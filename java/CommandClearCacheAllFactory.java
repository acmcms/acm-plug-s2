 ...
 * @author myx
 */
final class CommandClearCacheAllFactory implements ObjectFactory<Object, ControlContainer<?>> {
	...
	static final class CreateContainer extends AbstractContainer<CreateContainer> {
		...
		public Object getCommandResult(final ControlCommand<?> command, final BaseObject arguments) {

			{
				...
				this.parent.getServer().logQuickTaskUsage("XDS_COMMAND_STORAGE(2)_CC", result);
			}
